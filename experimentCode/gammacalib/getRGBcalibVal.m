function [screen]=getRGBcalibVal(screen,const,keys,textExp,button)
% ----------------------------------------------------------------------
% [screen]=getRGBcalibVal(screen,const,keys,textExp,button)
% ----------------------------------------------------------------------
...
csvwrite(sprintf('%s/Gamma/%s/%i/GRAY_Lin/Ini_RedGammaTable_%s_%i.csv',dirC,screen.name,screen.dist,screen.name,screen.dist),tabCalibRed);
csvwrite(sprintf('%s/Gamma/%s/%i/GRAY_Lin/Ini_GreenGammaTable_%s_%i.csv',dirC,screen.name,screen.dist,screen.name,screen.dist),tabCalibGreen);
csvwrite(sprintf('%s/Gamma/%s/%i/GRAY_Lin/Ini_BlueGammaTable_%s_%i.csv',dirC,screen.name,screen.dist,screen.name,screen.dist),tabCalibBlue);
...
csvwrite(sprintf('%s/Gamma/%s/%i/GRAY_Lin/RGB_GammaTabExtPowerFun_%s_%i.csv',dirC,screen.name,screen.dist,screen.name,screen.dist),gammaTable);
csvwrite(sprintf('%s/Gamma/%s/%i/GRAY_Lin/RGB_ParamFitExtPowerFun_%s_%i.csv',dirC,screen.name,screen.dist,screen.name,screen.dist),paramFit);

% Save figure
plot_file= sprintf('%s/Gamma/%s/%i/GRAY_Lin/RGB_GammaCurves_%s_%i',dirC,screen.name,screen.dist,screen.name,screen.dist);
saveas(f2,plot_file);
