...
% with one break. range of cx restricted for steady state phase onset
%  ly\    
%     \  /ry 
%      \/
%       (cx,cy)
...
function [cx,cy,ly,ry] = changeDetectRestricted(x,y)
warning off; 
...
p = lsqnonlin(@myfun,p0,[x(1)+ms2frames(50), -inf, -inf, -inf],[x(1)+ms2frames(250), inf, inf, inf],options);
